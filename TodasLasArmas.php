...
<head>
    ...
    <style>
        body{
            background-image: url(view/imgs/hoth.jpg);
...
?>
    ...
    <div class="container" id="principal-container">
        <h3 class="titulo-seccion">Todas las armas del universo Star Wars:</h3>
        <br />
        <br />
    ...
    <script>
            ...
            xmlhttp.open('GET', 'controller/busquedaArmas.php', true);
            xmlhttp.send();
    </script>
